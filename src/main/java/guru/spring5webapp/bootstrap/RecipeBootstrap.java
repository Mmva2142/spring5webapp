...
import guru.spring5webapp.model.*;
import guru.spring5webapp.repositories.CategoryRepository;
import guru.spring5webapp.repositories.RecipeRepository;
import guru.spring5webapp.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //guacNotes.setRecipe(guacRecipe);  在setter方法里设置了
        ...
        //tacoNotes.setRecipe(tacosRecipe); 在setter方法里设置了
